...
function rb_landing_defaults() {
	return array(
		...
		'proof_m2_value'     => '+3',
		'proof_m2_label'     => 'setores exigentes - automóvel, restauração, estética/saúde, arquitetura, imobiliário, etc.',
		'proof_m3_value'     => '4',
		'proof_m3_label'     => 'passos de método - do diagnóstico à otimização',
		'promise_eyebrow'    => 'A nossa promessa',
		'promise_heading'    => 'Não prometemos posts virais. Prometemos direção.',
		...
		'promise_no_1'       => 'Promessas de post viral ou resultados milagrosos',
		...
		'faq_5_a'            => 'Trabalhamos por projeto e por avença, a partir de âmbitos desenhados no diagnóstico. Não somos a opção mais barata - somos a que se paga em perceção e pipeline. O diagnóstico é gratuito e sem compromisso.',
