...
function rb_landing_register_fields() {
	...
	$schema = array(
		...
		'Prova' => array(
			...
			array( 'proof_quote', 'Testemunho', 'textarea' ),
			array( 'proof_quote_author', 'Testemunho — autor', 'text' ),
			array( 'proof_chip', 'Selo de garantia', 'text' ),
			array( 'proof_guarantee', 'Texto da garantia', 'textarea' ),
		),
